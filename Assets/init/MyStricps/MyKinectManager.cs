...
//						}
	...
	void UpdateColorMap()
	{
		...
		CameraPlane.GetComponent<Renderer>().material.mainTexture = usersClrTex;
	}
...
//				}
				if(i<=15)
				{
					Vector3 tempv = new Vector3(-posJoint.x*6400/1920+3200,-posJoint.y*3600/1080+1800,3100);

					Debug.Log(bodyData.joint[0].kinectPos.ToString());
